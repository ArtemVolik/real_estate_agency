# Generated by Django 2.2.4 on 2020-12-04 11:43
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('property', '0008_auto_20201204_1417'),
    ]
            ...
            fields=[
                ...
                ('owners_pure_phone',
                 phonenumber_field.modelfields.PhoneNumberField(
                     ...
                     verbose_name='Нормализованый номер владельца')),
                ('flat_in_property',
                 models.ManyToManyField(
                     db_index=True, related_name='flat_owners',
                     to='property.Flat')),
            ],
        ),
    ]
